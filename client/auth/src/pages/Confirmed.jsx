                      ...
                      <div className="card-body">
                        <div className="auth-form">
                          <div className="text-center">
                            ...
                            path !== "/forgot-password/sent" ? (
                              <p className="mt-3">
                                A mail has been send to <b>{email}</b>. Please
                                check for an email from
                                <b> SafewayFX </b>in your inbox, spam or junk
                                folder and click on the included link to{" "}
                                {path === "/verify"
                                  ? "verify your account."
                                  : "reset your password."}
                              </p>
                              ...
                              <p className="mt-3">
                                <b>HURRAY!!</b> Your email is now verified.
                              </p>
                            )}
                            {path !== "/verify"?<div className="d-inline-block mt-3">
                              <Link
                                to="/"
