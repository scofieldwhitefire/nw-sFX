(function (jQuery) {
  ...
  setTimeout(() => {
    ...
    const chartFunction = {
      ...
      generateDayWiseTimeSeries(baseval, count, yrange) {
        ...
        while (i < count) {
          let x = baseval;
          let y =
            Math.floor(Math.random() * (yrange.max - yrange.min + 8)) +
            yrange.min;
    ...
    if (jQuery("#multiple-radialbar-chart").length) {
      ...
      if (ApexCharts !== undefined) {
        var chart = new ApexCharts(
          document.querySelector("#multiple-radialbar-chart"),
          options
        );
        chart.render();
      }
    ...
    if (jQuery("#market-overview-chart").length) {
        ...
        series: [
          {
            ...
            data: [
              ...
              [1352415600000, 3200.9],
              [1352674800000, 3200.7],
              ...
              [1353625200000, 3300.4],
              [1353884400000, 3300.3],
              [1353970800000, 3300.18],
              [1354057200000, 3300.88],
              [1354143600000, 3400.09],
              [1354230000000, 3400.61],
              [1354489200000, 3400.7],
              [1354575600000, 3500.3],
              [1354662000000, 3500.4],
              ...
              [1356562800000, 3700.3],
              [1356649200000, 3600.9],
              ...
              [1359932400000, 3800.1],
              [1360018800000, 3800.51],
              [1360105200000, 3800.4],
      ...
      var chart = new ApexCharts(
        document.querySelector("#market-overview-chart"),
        options
      );
      chart.render();
